function attemptAvoid = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   ATTEMPTAVOID = IMPORTFILE1(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   ATTEMPTAVOID = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   attemptAvoid = importfile1('attemptAvoid.txt', 1, 2114);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/05/30 17:47:33
