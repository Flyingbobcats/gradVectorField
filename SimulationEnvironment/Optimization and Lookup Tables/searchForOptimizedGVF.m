...
%
% Description:
% Script determines the cost of avoiding an obstacle for a range of GVF 
% circulation (H) and decay radius (k) inputs. The output of the script is
% a surface plot where:
%       x axis --> Decay radius
%       y axis --> Circulation
%       z axis --> Path deviation cost for a given circ and decay
