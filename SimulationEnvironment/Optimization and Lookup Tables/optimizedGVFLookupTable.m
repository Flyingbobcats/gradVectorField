...
%
% Run to generate lookup tables. Resolution of lookup tables are dependent
% on the arrays ns and cs. ns represents the non-dimensional multiplier for
% the obstacles radius -  in terms of the UAVs turning radius. cs
% represents the non-dimensional multiplier for the obstacles lateral
% position with respect to the target path - in terms of the UAVs turning
% radius.
%
%
%   ro  = n(theta_r)    Obstacles radius = n * turning radius [1,inf)
%   Yo  = c(theta_r)    Lateral position = c * turning radius (-1,1)
%
