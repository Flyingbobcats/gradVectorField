...
%
% Description: 
% Script that optimized GVF circulation H and decay radius k parameters to
% minimize a path deviation cost function (gamma bar from thesis). 
%
%
% INPUT                                                 OUTPUT
% ------------------------------------------------------------------------
% UAV properities (speed)                         Optimized cost
% UAV initial condition         fmincon()          Optimzed circ (H)
% Obstacle configuration       ============>      Optimized decay rad (k)      
%     - radius n
%     - lateral position c
%
%
